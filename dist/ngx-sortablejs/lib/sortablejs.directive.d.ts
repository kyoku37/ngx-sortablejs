...
export declare class SortablejsDirective implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<SortablejsDirective, "[sortablejs]", never, { "sortablejs": { "alias": "sortablejs"; "required": false; }; "sortablejsContainer": { "alias": "sortablejsContainer"; "required": false; }; "sortablejsOptions": { "alias": "sortablejsOptions"; "required": false; }; "sortablejsCloneFunction": { "alias": "sortablejsCloneFunction"; "required": false; }; }, { "sortablejsInit": "sortablejsInit"; }, never, never, false, never>;
}
